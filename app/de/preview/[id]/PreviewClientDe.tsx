        ...
        <div className="w-full max-w-6xl">
          <div className="mb-3 text-center lg:text-left">
            <h1 className="text-2xl font-black text-slate-900">
              {de.preview.title} <span className="text-blue-600">{spec?.flag || ""} {spec?.country || ""}</span>
            </h1>
          </div>
            ...
            <div className="w-full lg:w-[62%] space-y-4">
              <div className="bg-white rounded-md border border-slate-100 overflow-hidden ">
                <div className="px-5 pt-5 pb-3 flex items-center justify-between">
                  <p className="text-sm font-bold text-slate-900 mt-0.5 flex items-center gap-1.5"><Icon d={ICONS.photo} size={14} className="text-blue-600" /> {spec?.country || "Dokumentfoto"}</p>
                </div>
        ...
        <>
          <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/96 backdrop-blur-xl border-t border-slate-200 shadow-[0_-8px_32px_rgba(0,0,0,0.12)] px-4 pt-3 pb-4 lg:hidden">
            <div className="max-w-lg mx-auto">
              ...
              <p className="text-center text-[10px] text-slate-400 mt-2 flex items-center justify-center gap-1.5"><Icon d={ICONS.lock} size={11} className="text-slate-400 shrink-0" /> {de.payment.secureCheckout} · {de.payment.refundIfRejected} · {de.payment.noSubscription}</p>
            </div>
          </div>
